...
export type ToastPayload = {
  title: string;
  message?: string;
  /** Muestra sello de verificación sin enlaces técnicos */
  verified?: boolean;
};
...
export function AppToast({
  ...
  return (
    <div
      className="fixed bottom-5 right-5 z-50 max-w-sm animate-[fadeIn_0.2s_ease-out] rounded-2xl border border-med-secondary/30 bg-white p-4 shadow-[var(--med-shadow)]"
      role="status"
      aria-live="polite"
    >
